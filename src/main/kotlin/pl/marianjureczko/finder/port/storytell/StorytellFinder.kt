...
class StorytellFinder : FinderTemplate<StorytellResponse>(listOf("Storytell")) {
    ...
    override fun analyseResponse(resultBody: StorytellResponse, title: String, sourceType: String, author: String): String {
        return responseAnalyser.execute(resultBody, title, author)
    }
}